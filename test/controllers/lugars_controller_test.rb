...
class LugarsControllerTest < ActionController::TestCase
  ...
  test "should create lugar" do
    assert_difference('Lugar.count') do
      post :create, lugar: { descripcion: @lugar.descripcion, foto: @lugar.foto, nombre: @lugar.nombre, rating: @lugar.rating }
    end
  ...
  test "should update lugar" do
    patch :update, id: @lugar, lugar: { descripcion: @lugar.descripcion, foto: @lugar.foto, nombre: @lugar.nombre, rating: @lugar.rating }
    assert_redirected_to lugar_path(assigns(:lugar))
  end
